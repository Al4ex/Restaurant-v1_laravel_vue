        ...
        <div class="row">
            <div class="col-md-8 order-md-1">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(data, i) in listProd" :key="i">
                            <td>{{ data.prod_id }}</td>
                            ...
                            <td>
                                <button
                                    type="button"
                                    class="btn btn-info"
                                    v-if="data.prod_visible == 1"
                                    v-on:click="updateSatus(data.prod_id, 0)"
                                >
                                    Activo
                                </button>
                                <button
                                    ...
                                    class="btn btn-light"
                                    v-else
                                    v-on:click="updateSatus(data.prod_id, 1)"
                                >
                                    Desactivado
                                </button>
                            </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button
                                    ...
                                    v-on:click="sendNetwordCreateProduct()"
                                >
                                    Guardar
                                </button>
                            </div>
    ...
    methods: {
        ...
        sendNetwordCreateProduct() {
            if (this.campoName == "") {
                ...
                axios
                    .post("api/Producto/create", formData)
                    .then((response) => {
                        // limpiar campo_
                        this.$swal.fire(
